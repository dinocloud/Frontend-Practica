...
node {
    ...
    /*In this stage, we build the apk using ionic cordova framework */
    {
      ...
      sh "jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore /home/ubuntu/certs/dinocloud.keystore android-release-unsigned.apk dinocloud "
      sh "zipalign -f -v 4 android-release-unsigned.apk android-DinoToDO-Dinocloud.apk"
